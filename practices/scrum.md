...
2. **Events**
   Prescribed events are used to create regularity and to minimize the need for meetings not defined in Scrum. The heart of Scrum is a Sprint during which a "done", useable and potentially releasable product Increment is created. The other events are Planning, Daily scrum (also known as Stand-up), Review (or Demo) and Retrospective.
3. **Artifacts**
...
2. **Create the initial Product backlog**
   It is a priority list of all features that need to be done within the project. The Project backlog usually contains three types of work items: Epic, User stories, and Tasks.
