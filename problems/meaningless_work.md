...
Avoid meaningless work! Learn how to deliver value and stop spending time on tasks without purpose.
...
- **The product does not have customers**
   Typical for startups without validated assignments or prototyping. There are plenty of techniques for the validation, such as [Lean Canvas](/practices/lean-canvas).
...
- **Lack of information**
  The developers do not understand why they have implemented this thing. They did not get any explanation.
